...
| `C04` | Plain-text `Tideproof` name, UI copy, and synthetic Highwater Drill labels in `web/index.html` and `web/app.js`; file hashes `81b621e6073daa3f465fefe73389719da4c399f1b7a88d5b261cc8fe7a1b07a8` and `825b5466035432c30598aa4b43c4a9e428d4ec88df8599cfacc25ee208a02a10` | Tideproof project; newly authored under the clean-room boundary documented in `CLEAN_ROOM.md` | Repository MIT license for source and copy only; no name clearance claimed | Current public source and local proof copy only. A pre-existing adjacent `TideProof` repository is recorded in `docs/PRIOR_ART.md`; final branding, video, and submission are blocked pending an entrant rename/clearance decision. No third-party artwork or wordmark is implied. | Nunan, 2026-07-31 — `CLEARED_CURRENT` |

...
| `V02 web/brand/tideproof-mark.svg` | Square SVG master with `1024 × 1024` view box; verified exports at `512`, `192`, `180`, `32`, and `16` px | App icon, favicon, social avatar | `SPEC_ONLY`; must derive from V01's system, not from a generated wave glyph |

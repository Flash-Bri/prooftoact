...
| `@aws-sdk/types` | `3.974.2` | `node_modules/@aws-sdk/types` | runtime | no | no | `Apache-2.0` |
| `@aws-sdk/xml-builder` | `3.972.37` | `node_modules/@aws-sdk/xml-builder` | runtime | no | no | `Apache-2.0` |

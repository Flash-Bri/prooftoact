...
case "$preflight_status" in
  ...
  57) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_OBSERVED_AT ;;
  58) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_OBSERVED_AT_WINDOW ;;
  ...
  86) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_NAME ;;
  87) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_TYPE ;;
  88) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_TIME_UNIT ;;
  89) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_SCOPE_COST_FILTERS ;;
  90) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_SCOPE_FILTER_EXPRESSION ;;
  91) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_SCOPE_BILLING_VIEW ;;
  92) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_FIXED_AUTO_ADJUST ;;
  93) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_FIXED_PLANNED_LIMITS ;;
  94) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_METRICS_BASIS ;;
  95) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_COST_TYPES_BASIS ;;
  96) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_START ;;
  97) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_END ;;
  98) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_ORDER ;;
  99) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_NOT_STARTED ;;
  100) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_EXPIRED ;;
  101) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_PERIOD_RELEASE_HORIZON ;;
  102) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_LIMIT_UNIT ;;
  103) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_LIMIT_AMOUNT_FORMAT ;;
  104) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_LIMIT_NONNEGATIVE ;;
  105) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_LIMIT_FIXED ;;
  106) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_ACTUAL_SPEND_UNIT ;;
  107) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_ACTUAL_SPEND_AMOUNT_FORMAT ;;
  108) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_ACTUAL_SPEND_NONNEGATIVE ;;
  109) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_BUDGET_ACTUAL_SPEND_CEILING ;;
  110) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_PERIOD_START ;;
  111) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_PERIOD_END ;;
  112) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RESPONSE_GROUPED_UNPAGINATED ;;
  113) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_ROWS ;;
  114) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_ROW_PERIOD ;;
  115) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RECORD_TYPE_GROUPS ;;
  116) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RECORD_TYPE_SEMANTICS ;;
  117) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RECORD_TYPE_UNBLENDED_UNIT ;;
  118) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RECORD_TYPE_SIGNED_DECIMAL_FORMAT ;;
  119) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RECORD_TYPE_SIGNED_RANGE ;;
  120) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_POSITIVE_RECORD_TYPE_TOTAL_RANGE ;;
  121) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_CEILING_DECIMAL_FORMAT ;;
  122) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_CEILING_RANGE ;;
  123) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_CEILING ;;
...
if ! /usr/bin/jq -e \
  ...
  'type == "object" and
   .schemaVersion == "tideproof.gate2.aws-preflight.v7" and
   .status == "PASS" and
   .sourceCommit == $source_commit and
   .treeDigest == $tree_digest and
   .region == "us-east-1" and
   .controls.authenticatedAwsCaller == true and
   .controls.currentCost.scope ==
    "ACCOUNT_WIDE_PROJECT_WINDOW_POSITIVE_RECORD_TYPE_EXPOSURE" and
   .controls.currentCost.groupedBy == "RECORD_TYPE" and
   .controls.currentCost.negativeOffsetsAppliedToExposure == false and
   (.controls.currentCost.positiveRecordTypeExposureUsd |

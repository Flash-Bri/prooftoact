...
case "$preflight_status" in
  ...
  112) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_RESPONSE_UNPAGINATED ;;
  ...
  115) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_UNIT ;;
  116) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_AMOUNT_FORMAT ;;
  117) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_NONNEGATIVE ;;
  118) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_DECIMAL_FORMAT ;;
  119) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_RANGE ;;
  120) fail_closed_stage AWS_READ_ONLY_STAGE_ACCOUNT_PREFLIGHT_VALIDATE_COST_UNBLENDED_TOTAL_RANGE ;;
